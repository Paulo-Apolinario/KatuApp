...
export default function NovoPequenoGeradorScreen() {
  ...
  async function handleSalvar() {
    ...
    if (!nome.trim() || !endereco.trim() || !telefone.trim() || !normalizedEmail) {
    ...
    try {
      ...
      Alert.alert(
        ...
        "O pequeno gerador foi cadastrado. Agora ele precisa clicar em 'Já fui cadastrado pela cooperativa' para liberar o acesso com o e-mail informado.",
        [
          {
            text: "OK",
      ...
      console.error("Erro ao salvar pequeno gerador:", error);
      Alert.alert("Erro", "Não foi possível cadastrar o pequeno gerador.");
    } finally {
      setSaving(false);
    }
  }
