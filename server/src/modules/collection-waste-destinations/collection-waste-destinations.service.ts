...
const CANCELLED_DESTINATION_STATUS =
  WasteDestinationStatus.CANCELLED;

const ACTIVE_DESTINATION_STATUS =
  WasteDestinationStatus.ACTIVE;
...
function calculateTotalsByUnit(
  ...
  for (const destination of destinations) {
    ...
    unitTotals.totalQuantity +=
      normalizeNumber(destination.quantity);
...
export class CollectionWasteDestinationsService {
  ...
  private async getAccessContext(
    ...
    throw new WasteDestinationDomainError(
      ...
      {
        statusCode: 403,
        code: "WASTE_DESTINATION_ACCESS_DENIED",
      }
    );
  }
  ...
  private assertCanManageDestinations(
    ...
    if (!canManage) {
      throw new WasteDestinationDomainError(
        ...
        {
          statusCode: 403,
          code: "WASTE_DESTINATION_MANAGEMENT_DENIED",
        }
      );
    }
  }
  ...
  private calculateEntryState(
    ...
    let status: CollectionEntryStatus =
  ...
  async create(
    ...
    this.assertCanManageDestinations(
      context
    );
    ...
    const transactionResult =
      await prisma.$transaction(
        async (
          transaction
        ): Promise<DestinationCreateTransactionResult> => {
          const entry =
            await transaction.collectionWasteEntry.findUnique({
              where: {
                id: data.collectionWasteEntryId,
              },
          ...
          if (!entry) {
            throw new WasteDestinationDomainError(
              ...
              {
                statusCode: 404,
                code: "COLLECTION_WASTE_ENTRY_NOT_FOUND",
              }
            );
          }
          ...
          if (
            ...
            throw new WasteDestinationDomainError(
              ...
              {
                statusCode: 403,
                code: "COLLECTION_WASTE_ENTRY_ACCESS_DENIED",
              }
            );
          }
          ...
          if (
            ...
            throw new WasteDestinationDomainError(
              ...
              {
                statusCode: 409,
                code: "COLLECTION_WASTE_ENTRY_CANCELLED",
              }
            );
          }
          ...
          if (
            ...
            throw new WasteDestinationDomainError(
              ...
              {
                statusCode: 400,
                code: "INVALID_DESTINATION_QUANTITY",
              }
            );
          }
          ...
          if (
            ...
            throw new WasteDestinationDomainError(
              ...
              {
                statusCode: 409,
                code: "ENTRY_WITHOUT_AVAILABLE_BALANCE",
              }
            );
          }
          ...
          if (
            ...
            if (!data.stockItemId) {
              throw new WasteDestinationDomainError(
                ...
                {
                  statusCode: 400,
                  code: "STOCK_ITEM_REQUIRED",
                }
              );
            }

            stockItem =
              await transaction.wasteStockItem.findUnique({
                where: {
                  id: data.stockItemId,
                },
            ...
            if (!stockItem) {
              throw new WasteDestinationDomainError(
                ...
                {
                  statusCode: 404,
                  code: "WASTE_STOCK_ITEM_NOT_FOUND",
                }
              );
            }

            if (
              stockItem.cooperativeId !==
              entry.cooperativeId
            ) {
              throw new WasteDestinationDomainError(
                ...
                {
                  statusCode: 403,
                  code: "STOCK_ITEM_COOPERATIVE_MISMATCH",
                }
              );
            }
            ...
            if (!stockItem.isActive) {
              throw new WasteDestinationDomainError(
                ...
                {
                  statusCode: 409,
                  code: "WASTE_STOCK_ITEM_INACTIVE",
                }
              );
            }
          ...
          const destination =
            await transaction.collectionWasteDestination.create({
              data: {
                cooperativeId:
                  entry.cooperativeId,
          ...
          if (
            ...
            const existingLot =
              await transaction.wasteStockLot.findFirst({
                where: {
                  cooperativeId:
                    entry.cooperativeId,
            ...
            stockLot =
              await transaction.wasteStockLot.create({
                data: {
                  ...
                  originCollectionMaterialId:
                    entry.collectionMaterialId,

                  originCollectionWasteEntryId:
                    entry.id,
            ...
            await transaction.collectionWasteDestination.update({
              where: {
                id: destination.id,
              },
          ...
          const newDestinedQuantity =
            normalizeNumber(
              entry.destinedQuantity
            ) + destinationQuantity;

          const recalculatedEntry =
            this.calculateEntryState(
              normalizeNumber(
          ...
          const updatedEntry =
            await transaction.collectionWasteEntry.update({
              ...
              data: {
                destinedQuantity:
                  new Prisma.Decimal(
                    recalculatedEntry.destinedQuantity
                  ),

                remainingQuantity:
                  new Prisma.Decimal(
                    recalculatedEntry.remainingQuantity
                  ),

                status:
                  recalculatedEntry.status,
          ...
          const completeDestination =
            await transaction.collectionWasteDestination.findUnique({
              where: {
                id: destination.id,
              },
  ...
  async list(
    authUserId: string,
    authUserRole: string,
    filters: WasteDestinationListQuery
  ) {
    const context =
      await this.getAccessContext(
        authUserId,
    ...
    const [
      ...
      prisma.collectionWasteDestination.count({
        where,
      }),
  ...
  async findById(
    ...
    const destination =
      await prisma.collectionWasteDestination.findFirst({
        where: {
          AND: [
            {
              id: destinationId,
    ...
    if (!destination) {
      throw new WasteDestinationDomainError(
        "Destinação de resíduo não encontrada.",
        {
          statusCode: 404,
  ...
  async update(
    ...
    const destination =
      await prisma.collectionWasteDestination.update({
        where: {
          id: destinationId,
        },
    ...
    return {
      ...
      message:
        "Destinação atualizada com sucesso.",
  ...
  async cancel(
    ...
    const result =
      await prisma.$transaction(
        async (transaction) => {
          const destination =
            await transaction.collectionWasteDestination.findFirst({
              where: {
                AND: [
                  {
                    id: destinationId,
          ...
          if (
            ...
            throw new WasteDestinationDomainError(
              "A destinação já está cancelada.",
              {
                statusCode: 409,
                code: "WASTE_DESTINATION_ALREADY_CANCELLED",
              }
          ...
          if (
            ...
            const originalQuantity =
              normalizeNumber(
                destination.stockLot.quantity
              );

            const availableQuantity =
              normalizeNumber(
                destination.stockLot.availableQuantity
              );
          ...
          const activeDestinations =
            await transaction.collectionWasteDestination.findMany({
              where: {
                collectionWasteEntryId:
          ...
          const remainingDestinedQuantity =
    ...
    return {
      ...
      message:
        "Destinação cancelada e saldo da entrada recalculado com sucesso.",
